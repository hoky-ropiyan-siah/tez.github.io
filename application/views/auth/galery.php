...
<button type="button" class="btn btn-info btn" style="font-size:18x;" ><?= anchor('galery/edit/'.$gal->id, '<div class="btn btn-info btn-sm"><i class="fas fa-edit"></i></div> ') ?></button>
